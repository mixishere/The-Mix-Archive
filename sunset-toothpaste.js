(function(){
  ...
  Object.assign(sunsetRoot.style, {
    ...
    background: "linear-gradient(180deg, #0A3D62 0%, #1E5F9C 15%, #3CAEA3 30%, #8DE6D0 45%, #FFFFFF 50%, #8DE6D0 55%, #3CAEA3 70%, #1E5F9C 85%, #0A3D62 100%)",
  ...
  titleText.innerHTML = "Toothpaste v1<br><span style=\"font-size:12px; font-weight:normal;\">(drag the title to move the GUI)</span>";
  ...
  [minimizeBtn, fullscreenBtn, closeBtn, sunBtn].forEach(btn => {
    ...
    btn.onmouseenter = () => { btn.style.background = "#3CAEA3"; };
    btn.onmouseleave = () => { btn.style.background = "#8DE6D0"; };
  });
